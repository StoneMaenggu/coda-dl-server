...
import os
import numpy as np
from utils.timeseries_GCN import TimeSeriesGCN
import pandas as pd
...
class P2G_Module:
    ...
    def get_features(self,pose):
        ...
        print(self.adjacent_matrix.shape)
...
if __name__ == '__main__':
    ...
    # init
    p2g = P2G_Module(checkpoint_path='/home/horang1804/Dolmaggu/coda-modeling/Pose2Gloss/checkpoint/pose2gloss/4/epoch_last.pt',
